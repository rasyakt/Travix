...
<head>
    ...
    <title>Login | Travix — Premium Travel</title>
...
<body class="bg-tv-bg h-screen antialiased overflow-hidden">
    <div class="flex h-screen">
        ...
        <div class="hidden lg:block w-1/2 relative overflow-hidden">
            <img src="https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&q=80&w=2070"
            ...
            <div class="absolute bottom-16 left-16 max-w-md">
                ...
                <p class="text-white/80 text-lg font-medium leading-relaxed">
                    Log in to your account to manage your bookings, check-in online, and explore exclusive member-only
                    travel deals.
                </p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 bg-white overflow-y-auto scrollbar-thin">
            <div class="min-h-full flex flex-col justify-center py-20 lg:py-28 px-8">
                <div class="w-full max-w-md mx-auto">
                    ...
                    <h2 class="text-3xl font-extrabold text-tv-text mb-2">Welcome Back</h2>
                    <p class="text-tv-muted">Please enter your details to sign in.</p>
                </div>

                {{-- Login/Signup Toggle --}}
                <div class="bg-gray-100 p-1 rounded-2xl flex mb-8">
                    <button
                        class="flex-1 py-3 text-sm font-bold rounded-xl bg-white shadow-sm text-tv-text transition-all">Login</button>
                    <a href="{{ route('register') }}"
                        class="flex-1 py-3 text-sm font-bold rounded-xl text-tv-muted hover:text-tv-text transition-all text-center">Sign
                        Up</a>
                </div>
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="email" id="email" name="email" class="tv-input pl-11 @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label for="password" class="tv-label mb-0">Password</label>
                            <a href="#" class="text-xs font-bold text-tv-primary hover:underline">Forgot password?</a>
                        </div>
                        <div class="relative group">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-tv-muted group-focus-within:text-tv-primary transition-colors">
                            ...
                            <input type="password" id="password" name="password" class="tv-input pl-11 pr-12 @error('password') border-red-500 @enderror"
                    ...
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm font-medium text-tv-muted">Stay signed in for 30
                            days</label>
                    </div>

                    <button type="submit"
                        class="btn-tv-primary w-full py-4 text-lg shadow-lg shadow-blue-100 hover:shadow-xl hover:shadow-blue-200 transition-all">
                        Sign In
                    </button>
                </form>
                ...
                <div class="my-8 relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-tv-muted">Or continue with</span>
                    </div>
                </div>
