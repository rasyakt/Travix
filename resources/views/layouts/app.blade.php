...
<body class="min-h-screen flex flex-col">
    ...
    {{-- ═══ Custom Footer ═══ --}}
    {{-- ═══ Custom Footer ═══ --}}
    <footer class="bg-tv-secondary py-12 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-1">
                    <div class="flex items-center gap-2.5 group mb-4">
                        <div class="w-8 h-8 rounded-lg bg-white flex items-center justify-center p-1 shadow-sm">
                            <img src="{{ asset('img/pln.png') }}" alt="Travix Logo" class="w-full h-full object-contain">
                        </div>
                        <span class="text-xl font-black tracking-tight text-white">Travix</span>
                    </div>
                    <p class="text-white/50 text-xs leading-relaxed mb-4">Redefining luxury travel with premium service, transparency, and comfort.</p>
                    <div class="flex items-center gap-2.5">
                        <a href="#" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-all hover:scale-105" title="Twitter">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg>
                        </a>
                        <a href="#" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-all hover:scale-105" title="Instagram">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <div>
                    <h4 class="text-xs font-black uppercase tracking-widest mb-4 text-white/40">Company</h4>
                    <ul class="space-y-2.5">
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">About Us</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Careers</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Blog</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Press</a></li>
                    </ul>
                </div>

                <div>
                    <h4 class="text-xs font-black uppercase tracking-widest mb-4 text-white/40">Support</h4>
                    <ul class="space-y-2.5">
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Help Center</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Terms of Service</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Privacy Policy</a></li>
                        <li><a href="#" class="text-white/60 hover:text-white transition-colors text-xs font-bold">Cookie Policy</a></li>
                    </ul>
                </div>

                <div>
                    <h4 class="text-xs font-black uppercase tracking-widest mb-4 text-white/40">Join the Trivix Club</h4>
                    <p class="text-white/50 text-xs mb-4 leading-relaxed">Subscribe for exclusive offers and travel inspiration.</p>
                    <div class="flex flex-col sm:flex-row gap-2">
                        <input type="email" placeholder="Email address"
                            class="flex-1 bg-white/5 border border-white/10 rounded-xl py-2.5 px-4 text-white text-xs placeholder-white/20 focus:outline-none focus:border-tv-primary focus:ring-1 focus:ring-tv-primary transition-all">
                        <button class="bg-tv-primary hover:bg-tv-primary/90 text-white font-black text-xs py-2.5 px-6 rounded-xl transition-all shrink-0">Subscribe</button>
                    </div>
                </div>
            </div>

            <div class="mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <p class="text-white/30 text-xs font-bold">&copy; 2026 Trivix Inc. All rights reserved.</p>
                <div class="flex flex-wrap justify-center items-center gap-6">
                    <a href="#" class="text-[10px] font-black uppercase text-white/30 hover:text-white/60 transition-colors">Sitemap</a>
                    <a href="#" class="text-[10px] font-black uppercase text-white/30 hover:text-white/60 transition-colors">Security</a>
                    <a href="#" class="text-[10px] font-black uppercase text-white/30 hover:text-white/60 transition-colors">Accessibility</a>
                </div>
            </div>
        </div>
    </footer>
